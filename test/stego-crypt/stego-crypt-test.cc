...
TEST(Steg, LSB1) {
  ...
  Embedding_agent embedder("test/stego-crypt/test.bmp", "test/stego-crypt/test-stego.bmp");
...
TEST(Steg, LSB2) {
  std::string test_string = "The quick brown fox jumped over the lazy dog.";
  Embedding_agent embedder("test/stego-crypt/test.bmp", "test/stego-crypt/test-stego.bmp", 2);
  embedder.embed_and_save(test_string);
